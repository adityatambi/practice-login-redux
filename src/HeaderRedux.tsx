...
export function HeaderRedux() {
  ...
  async function handleSignInclick() {
    ...
    if (authenticatedUser !== undefined) {
      ...
      if (authorizedPermissions) dispatch(authorizedAction(authorizedPermissions));
    }
  }
  return (
    <header className="flex justify-between items-center border-b-2 border-gray-100 py-6">
      {user ? (
        ...
        <button
          ...
          className="whitespace-nowrap inline-flex items-center justify-center ml-auto px-4 py-2 w-36 border border-transparent rounded-md shadow-sm text-base font-medium text-white
